export const NameScreeen = () => {
    return (<div className="page_two" style={{ display: "none" }}>
        ...
        <form className="form_main">
            ...
            <input type="tel" placeholder="+7 ( ___ ) ___ - __ - __" id="q_phone" />
        </form>
        <div className="btn_text">
            После нажатия на кнопку вы будете <br /> перенаправлены в WhatsApp.
        </div>
        <a className="ws_get whatsapp_ch btn_anim hrefUniqId" href="https://api.whatsapp.com/send?phone=79000000150&amp;text=Варианты квартир подобраны (№ 02812265718). Просто отправьте это сообщение ➡" target="blanc_">
