                ...
                <ul className="filtr_list">
                    <li> <div className="fl_title">Выберите количество комнат</div>
                        <ul className="fl_inner_list fl_room " id="kv_list">
                            <li><a data-price="2,5" data-fi="rooms_new[]=0" href="#">Студия</a></li>
                            <li><a data-price="3" className="act" data-fi="rooms_new[]=1" href="#">1к</a></li>
                            <li><a data-price="4,1" data-fi="rooms_new[]=2" href="#">2к</a></li>
                            <li><a data-price="5,9" data-fi="rooms_new[]=3" href="#">3к</a></li>
                        </ul>
                    </li>
                    <li>
                        <div className="fl_title">Год сдачи объекта</div>
                        <ul className="fl_inner_list " id="sroki_list">
                            <li><a data-fi="srok[]=2022" href="#">2022</a></li>
                            <li><a data-fi="srok[]=2023" href="#">2023</a></li>
                            <li><a data-fi="srok[]=2024" href="#">2024</a></li>
                            <li><a data-fi="srok[]=2026" href="#">2026</a></li>
                        </ul>
                    </li>
                </ul>

                <a className="ws_get   btn_anim " href="#">
