...
export const PhoneScreen = ({phone, setPhone, number}) => {
    ...
    return (<div className="page_two">
        ...
        <a className="ws_get whatsapp_ch btn_anim hrefUniqId" onClick={continueClick} href={`https://api.whatsapp.com/send?phone=79000000150&amp;text=Варианты квартир подобраны (№ ${number}). Просто отправьте это сообщение ➡`} target="blanc_">
