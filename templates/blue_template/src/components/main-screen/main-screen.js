                ...
                <div className="page page_1">
                    <div className="page_inner">
                        <div className="wmain">
                            ...
                            <div className="sub_title">{params.sub_title === undefined || params.sub_title==""?parse("Здесь собрана полная база квартир, более 30 000 вариантов. <br />За 1 минуту вы получите бесплатный доступ к самым выгодным предложениям!"):parse(params.sub_title)}</div>
