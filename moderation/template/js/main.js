$(document).ready(function() {
    ...
    function ajaxSendData(sendData, serverScriptName, sendType, celType, flag, btn) {
        $.ajax({
            type: sendType,
    ...
    function showAlert(mes, form_data, celType) {
        ...
        //     'value': 1
        // });
        ym(57527605, 'reachGoal', celType);
        ym(57527605, 'reachGoal', 'vse');
        _tmr.push({ id: '3167970', type: 'reachGoal', goal: celType });
        _tmr.push({ id: '3167970', type: 'reachGoal', goal: 'vse' });
    ...
    $("body").on("click", ".lead-btn", function() {
        ...
        if (phone == "" || phone.length !=18) {
            f = false;
            form.find(".form_phone").addClass("err");
        ...
        if (f) {
            if (email){
                ...
                $('#email_popup').find('.phone').val(phone)
            }
            ...
            console.log(celType);
            ajaxSendData(send_data, "/fd_log/ajax.php", "POST", celType, email, $(this))
        } else {
