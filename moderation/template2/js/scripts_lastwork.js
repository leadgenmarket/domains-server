...
$(function() {
    ...
    $('.tj_list li').click(function(){
        ...
        if(filt == 'car'){
            src = 'https://yandex.ru/map-widget/v1/-/CGgTJCnB';
        }else if(filt == 'train'){
            src = 'https://yandex.ru/map-widget/v1/-/CGgTJH-b';
        }else{
            src = 'https://yandex.ru/map-widget/v1/-/CGgTNEKW';
        }
    ...
    $("#loadflats").click(function() {
        ...
        var year = $('.param_year select').val();
        var area = $('.param_area select').val();
        var page = $('#loadflats').attr('data-page');
        $.ajax({
            type: "GET",
            url: "/flats_ajax.php?page=" + page + "&filt=" + filt + "&year=" + year + "&area=" + area,
            success: function(msg) {
