...
export default [
        ...
        children: [
            {
                name: 'Общий список',
                status: false,
                url: "/clients/all", //ClientsAll
            },
            {
                name: 'Заблокированные',
                status: false,
                url: "/clients/blocked", //ClientsAll
            },
        ]
    },
    {
    ...
    {
        name: 'Акции',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-percent"><line x1="19" y1="5" x2="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></svg>,
        status: false,
        url: "/actions",
        children: []
    },
        ...
        children: [
            {
                name: 'Cписок',
                status: false,
                url: "/halls/list", //ClientsAll
            },
            {
                name: 'Панорамы',
                status: false,
                url: "/halls/panoramas", //ClientsAll
            },
            /*{
                name: 'Схемы',
                status: true,
                url: "/halls/schemes", //ClientsAll
            },*/
            /*{
                name: 'Элементы схем',
                status: false,
                url: "/halls/elements", //ClientsAll
            },*/
        ]
    },
    {
    ...
    {
        name: 'Выход',
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>,
        status: false,
        url: "/logout",
        children: []
    },    
