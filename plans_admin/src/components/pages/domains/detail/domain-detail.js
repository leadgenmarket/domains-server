    ...
    const forms = [
        {
            ...
            fields: [
                ...
                {
                    name: 'Площадь второй спальни',
                    json: 'bed_room_area_2',
                    type: 'number',
                    empty: true,
                },
                {
                    name: 'Площадь третьей спальни',
                    json: 'bed_room_area_3',
                    type: 'number',
                    empty: true,
                },
                {
                    name: 'Площадь сан узла',
                    json: 'bath_room_area',
                    type: 'number',
                    empty: true,
                },
                {
                    name: 'Площадь второго сан узла',
                    json: 'bath_room_area_2',
                    type: 'number',
                    empty: true,
                },
            ],
