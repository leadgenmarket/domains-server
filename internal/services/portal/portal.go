...
func (p *portal) GetJkListAlt(cityRepo []models.City) ([]models.JK, error) {
	...
	ids := map[string][]int{
		...
		"ekb":      {312713, 309771, 309173, 309166, 304946, 304918, 276098, 265060, 304857, 304841, 295114, 294931, 294220, 274080, 229883, 229801, 229768, 229740},
		"voronezh": {313272, 313270, 313175, 313139, 313128, 309641, 309626, 309597, 309563, 309501, 309364, 153878, 153363, 172791, 153988, 153223, 153560, 153441, 313071, 309663, 309650, 313111, 313080, 313102, 313246, 313237, 313220, 313190, 313156, 309397},
	}
